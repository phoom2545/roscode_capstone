...
echo_and_run cd "/home/rai/ired_ws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/rai/ired_ws/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/rai/ired_ws/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
