// Generated by gencpp from file ired_msgs/Motor.msg
// DO NOT EDIT!


#ifndef IRED_MSGS_MESSAGE_MOTOR_H
#define IRED_MSGS_MESSAGE_MOTOR_H
...
struct Motor_
{
  ...
  typedef boost::shared_ptr< ::ired_msgs::Motor_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ired_msgs::Motor_<ContainerAllocator> const> ConstPtr;

}; // struct Motor_

typedef ::ired_msgs::Motor_<std::allocator<void> > Motor;

typedef boost::shared_ptr< ::ired_msgs::Motor > MotorPtr;
typedef boost::shared_ptr< ::ired_msgs::Motor const> MotorConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ired_msgs::Motor_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ired_msgs::Motor_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ired_msgs::Motor_<ContainerAllocator1> & lhs, const ::ired_msgs::Motor_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::ired_msgs::Motor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ired_msgs::Motor_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ired_msgs::Motor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ired_msgs::Motor_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ired_msgs::Motor_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ired_msgs::Motor_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ired_msgs::Motor_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ired_msgs::Motor_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xec2526e9a146e07cULL;
  static const uint64_t static_value2 = 0x0941072e0ef16c7bULL;
};

template<class ContainerAllocator>
struct DataType< ::ired_msgs::Motor_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ired_msgs::Motor_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ired_msgs::Motor_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ired_msgs::Motor_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ired_msgs::Motor_<ContainerAllocator>& v)
  {
...
#endif // IRED_MSGS_MESSAGE_MOTOR_H
